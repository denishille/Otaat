...
/* Startaufstellung des Everything Checkers.
   ...
   die Sachen, von denen weniger besser ist.
...
export const DEFAULT_CHECKS: CheckDef[] = [
  ...
  { id: 'sport',    name: 'Sport',         kind: 'multi',  sort: 30,
    ...
    noneOption: 'Nix' },
  { id: 'muscles',  name: 'Muskelkater',   kind: 'scale',  target: 2, inverse: true, sort: 40 },
  { id: 'mood',     name: 'Laune',         kind: 'scale',  target: 4, sort: 50 },
  { id: 'focus',    name: 'Fokus',         kind: 'scale',  target: 4, sort: 60 },
  { id: 'people',   name: 'Unter Menschen',kind: 'bool',   sort: 70 },
  { id: 'meditate', name: 'Meditation',    kind: 'bool',   sort: 80 },
  { id: 'sauna',    name: 'Sauna',         kind: 'bool',   sort: 90 },
  { id: 'scroll',   name: 'Doomscrolling', kind: 'number', unit: 'h',      step: 0.25, target: 1, inverse: true, sort: 100 },
  { id: 'coffee',   name: 'Kaffee',        kind: 'number', unit: 'Tassen', step: 1,    target: 3, inverse: true, sort: 110 },
  { id: 'booze',    name: 'Alkohol',       kind: 'number', unit: 'Gläser', step: 1,    target: 0, inverse: true, sort: 120 },
]
...
export const RETIRED_CHECK_IDS = ['mobility', 'food']
