...
| `supabase/migrations/` | Schema, Indizes, RLS. Wer sich anmelden darf, steht in `otaat_invited` — ohne Eintrag kommt niemand über den Signup-Trigger. Einladen: `insert into public.otaat_invited (email) values ('wer@example.com');` |
